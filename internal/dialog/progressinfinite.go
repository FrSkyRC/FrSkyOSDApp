...
func (d *ProgressInfiniteDialog) UpdateTitle(title string) {
	label := d.label.(*widget.Label)
	label.SetText(title)
}

func (d *ProgressInfiniteDialog) UpdateMessage(message string) {
	label := d.content.(*widget.Label)
